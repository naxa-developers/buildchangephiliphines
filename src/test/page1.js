...
class Page1 extends Component {
  ...
  onGoodPhotoTapped() {
    Actions.ComparePhotosScene({
      title: getLocalizedText(
        this.props.substep.local_title,
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        >
          <ImageViewer imageUrls={images} index={this.state.id} />
        </Modal>
        ...
        <ListView
          ...
          renderRow={rowData => {
            return (
              rowData.image && (
                <TouchableOpacity
                  onPress={this.showImageViewer.bind(
                    this,
                    this.props.substep.primary_photos.indexOf(rowData)
                  )}
                >
                  <PrimaryPhoto primaryPhoto={rowData} />
                </TouchableOpacity>
              )
            );
          }}
        ...
        <Text style={{ paddingLeft: 8, paddingRight: 8 }}>
          {this.props.substep.description}
        </Text>
        <View
          style={[
            styles.buttonContainer,
            styles.buttonContainerGoodPhotoBadPhoto
          ]}
        >
        ...
        <View
          style={[
            styles.buttonContainer,
            styles.buttonContainerCallInspectorReport
          ]}
        >
          {this.props.substep.call_inspector && (
            <TouchableOpacity
