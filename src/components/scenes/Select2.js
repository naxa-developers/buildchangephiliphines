...
import { View, Text, StyleSheet, TouchableOpacity, NetInfo, AsyncStorage, Alert, Image } from 'react-native';
      ...
      <View style={styles.mainContainer}>
        ...
        <TouchableOpacity style={[styles.subContainer, { backgroundColor: '#5184ac', marginBottom: 5 }]} onPress={() => Actions.GuidelineCategoryScene()}>
          ...
          <View style={styles.contentStyle}>
            ...
            <Text style={styles.textBoldStyle}>{strings.view_select2_subtitle1}</Text>
          </View>
          </TouchableOpacity>
...
export default connect(null, { openedGuidelinesCategoryScene })(Select2);
